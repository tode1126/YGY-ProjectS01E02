...
<c:if test ="${not empty list }">
  	<c:forEach items="${list }" var="dto" varStatus="i">
			<tr>
				...
				<td align="center"><input type="button" value="비활성화" class="red button" onclick="location.href='${root}/admin/userManagement/allUserList/userDisable.do?targetEmail=${dto.email }&pageNum=${currentPage }'"></td>
