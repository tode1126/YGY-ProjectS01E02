...
<script type="text/javascript" src="${root }/js/FnQ/goods.js"></script>
<script type="text/javascript" src="${root }/js/FnQ/client.js"></script>
<script type="text/javascript" src="${root }/js/FnQ/cancle.js"></script>
<script type="text/javascript" src="${root }/js/FnQ/order.js"></script>
<script type="text/javascript" src="${root }/js/FnQ/etc.js"></script>
...
<div class="FnQ">
		...
		<a href="#" id="Goods" class="li1">상품</a>
		<a href="#" id="Client" class="li1">회원</a>
		<a href="#" id="Cancle" class="li1">취소</a>
		<a href="#" id="Order" class="li1">주문/결제</a>
		<a href="#" id="Etc" class="li1">기타</a>
