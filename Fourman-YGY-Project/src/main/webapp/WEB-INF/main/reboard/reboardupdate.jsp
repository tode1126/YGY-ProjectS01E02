...
<div class="board">
	<form action="reboardListUpdate.do" id="insertBoardFrm" method="post" onsubmit="return check(this)"  >
		<table style="width: 800px;">
			...
			<tr>
				<th>제목</th>
				<td>
					<input type="text" name="reboard_subject" value="${dto.reboard_subject }" style="width: 250px;">
				</td>
			</tr>
			<tr>
				<th>별점</th>
				<td>
			    	...
			    	<input type="hidden" name="reboard_rating" id="star_score" value="${dto.reboard_rating }">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<textarea style="width: 400px; height: 150px;" name="reboard_content" id="reboard_content">${dto.reboard_content }</textarea>
				</td>
			</tr>
			<tr>
